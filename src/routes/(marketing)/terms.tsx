...
function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="January 10, 2026">
      ...
      <p>
        songcal is a service that syncs your Apple Music listening history to Google Calendar. When
        you play a song on Apple Music, the Service creates a corresponding calendar event showing
        the song details and the time it was played.
      </p>
      ...
      <p>
        The Service integrates with Google and Apple Music. Your use of these services is subject to
      ...
      <p>
        ...
        changes constitutes acceptance of the new terms. We will update the "Last updated" date when
        changes are made.
      </p>
...
const Route = createFileRoute("/(marketing)/terms")({
  component: TermsPage,
});
