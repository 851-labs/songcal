...
// Softer rose that fits the paper aesthetic
...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div
        className="day-page min-h-screen w-full relative"
        style={{ background: "var(--cal-cream)" }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(var(--cal-line) 1px, transparent 1px),
              linear-gradient(90deg, var(--cal-line) 1px, transparent 1px)
            `,
        ...
        <header className="relative z-50 px-6 md:px-10 py-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <Link
              ...
              style={{ color: "var(--cal-ink)" }}
            >
              <svg
                className="w-6 h-6"
                style={{ color: "var(--cal-rose)" }}
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <main className="relative z-10 px-6 md:px-10 h-[calc(100vh-88px)] flex items-center">
          <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: Hero text */}
            <div>
              <span
                className="inline-flex items-center gap-2 text-sm mb-4 ml-1"
                style={{ fontFamily: "Crimson Pro, serif", color: "var(--cal-muted)" }}
              >
                <span className="relative flex h-2 w-2">
                  <span
                    className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-75"
                    style={{ background: "var(--cal-rose)" }}
                  />
                  <span
              ...
              >
                Your music history,
                <br />
                <span style={{ color: "var(--cal-rose)" }}>on your calendar</span>
              </h1>
              ...
              <div className="flex flex-row items-start gap-4">
                ...
                <p
                  className="text-base pt-2 -rotate-1 hidden"
                  style={{
            ...
            <div
              ...
              style={{
                background: "var(--cal-warm)",
                boxShadow: "0 8px 60px rgba(26, 22, 18, 0.1)",
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: "var(--cal-line)", background: "var(--cal-warm)" }}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span
                      ...
                      style={{ fontFamily: "Crimson Pro, serif", color: "var(--cal-ink)" }}
                    >
                      Thursday
                    </span>
                    <span
              ...
              <div className="relative h-[calc(100%-72px)]">
                ...
                {HOURS.map((hour) => (
                  ...
                  >
                    ...
                    <div className="flex-1 border-t" style={{ borderColor: "var(--cal-line)" }} />
                  </div>
                ))}
